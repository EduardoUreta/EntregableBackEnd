    ...
    async addProduct(productForm){
        try {
            if(this.fileExist()){
                ...
                // A partir de ahora, se recibe desde el SV un productForm y lo desestructuro
                const { title, description, price, stock, thumbnail, code } = productForm;
                ...
                if(!title || !description || !price || !stock || !thumbnail || !code){
                    ...
                    if (!title) return console.log("Falta el campo 'title'");
                    if (!description) return console.log("Falta el campo 'description'");
                    if (!price) return console.log("Falta el campo 'price'");
                    if (!stock) return console.log("Falta el campo 'stock'");
                    if (!thumbnail) return console.log("Falta el campo 'thumbnail'");
                    if (!code) return console.log("Falta el campo 'code'");
                } else {
