...
productsRouter.get("/:pid", async (request, response) => {
    try {
        ...
        const getProductsById = await productsService.getProductsById(productId);
...
productsRouter.post("/", async (request, response) => {
    try {
        ...
        await productsService.addProduct(newProduct.title, newProduct.description, newProduct.price, newProduct.thumbnail, newProduct.code, newProduct.stock);
...
productsRouter.put("/:pid", async (request, response) => {
    try {
        ...
        await productsService.updateProduct(productId, putProduct.title, putProduct.description, putProduct.price, putProduct.thumbnail, putProduct.code, putProduct.stock)
